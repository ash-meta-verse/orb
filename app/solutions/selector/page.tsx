      ...
      <div className="relative z-10 w-full max-w-md px-4">
              ...
              <>
                ...
                >
                  <button
                    ...
                    className="w-full p-4 bg-black border border-gray-800 rounded-lg flex items-center justify-between hover:bg-gray-900 hover:border-primary/50 transition-all duration-300 group"
                  >
        ...
        <AnimatePresence>
          {showQuestion && (
            ...
            >
              <Link href="/" className="text-sm text-gray-500 hover:text-white transition-colors duration-300">
                Return to homepage
              </Link>
            </motion.div>
          )}
