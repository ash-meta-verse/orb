...
export default function SolutionsPage() {
  return (
    <main className="min-h-screen pt-20">
      ...
      {/* Solutions Cards */}
      <PageSection className="py-12 md:py-16 mb-20" animation="fadeInUp">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Solution 1: Agencies & Brands */}
          <AnimatedSection
            variant="fadeInLeft"
            delay={200}
            className="group relative overflow-hidden rounded-xl border border-border/50 bg-background hover:border-primary/50 transition-all duration-500 hover:shadow-xl hover:shadow-primary/10"
          >
      ...
      {/* CTA Section */}
      <PageSection variant="primary" animation="fadeIn">
