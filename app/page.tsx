...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen pt-14">
      {/* Hero Section */}
      <section className="relative container mx-auto px-4 pt-6 pb-32 md:pt-10 md:pb-40 min-h-[80vh] flex items-start overflow-hidden">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              quote:
                "Ash Agency has been an invaluable partner for our agency. Their ability to understand our clients' needs and deliver exceptional video content on tight deadlines has made them our go-to production team.",
            ...
            {
              quote:
                "Working with Ash Agency transformed my content and my career. Their strategic approach helped me grow my audience while staying true to my authentic voice.",
              author: "Jamie Lee",
            ...
            {
              quote:
                "As a startup founder, every dollar counts. Ash Agency delivered premium quality that justified the investment and has paid dividends in customer acquisition.",
